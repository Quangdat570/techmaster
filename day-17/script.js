...
// //     div.textContent = product.textContent;
...
// function createProductThumbnail() {
...
//     metal.classList.add('product-meta');
//     const titleel = document.createElement('h3');
//     titlel.classList.add("product-title");
//     titlel.textContent = title;

//     const pricel = document.createElement("div");
//     pricel.classList.add("product-price");
...
// const ortherBtn = document.querySelector('.abc');
// // event type
// ortherBtn.addEventListener("click", handleClick);


// const deleteBtn = document.querySelector(".cdf");
// deleteBtn.addEventListener('click', function() {
//     ortherBtn.removeEventListener("click", handleClick);
// })
